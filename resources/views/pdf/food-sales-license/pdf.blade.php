...
<body>
    ...
    <div class="box_text" style="text-align: left; margin-left: 5rem;">
        ...
        <span>ใบอนุญาตจัดตั้งสถานที่จำหน่ายอาหาร (สอ.4) โดยมีพื้นที่ประกอบการ</span>
        <span class="dotted-line"
            style="min-width: 15%;">{{ isset($fields['field_option']) && $fields['field_option'] == 1 ? $fields['field_35'] : ' ' }}</span>
        <span>ตารางเมตร</span>
        <br>

        <span>({{ isset($fields['field_option']) && $fields['field_option'] == 2 ? '/' : ' ' }})</span>
        <span>ใบอนุญาตจัดตั้งสถานที่สะสมอาหาร (สอ.5) โดยมีพื้นที่ประกอบการ</span>
        <span class="dotted-line"
            style="min-width: 15%;">{{ isset($fields['field_option']) && $fields['field_option'] == 2 ? $fields['field_35'] : ' ' }}</span>
        <span>ตารางเมตร</span>
        <br>

        <span>({{ isset($fields['field_option']) && $fields['field_option'] == 3 ? '/' : ' ' }})</span>
        <span>หนังสือรับรองการแจ้งตั้งสถานที่จำหน่ายอาหาร (สอ.6) โดยมีพื้นที่ประกอบการ</span>
        <span class="dotted-line"
            style="min-width: 15%;">{{ isset($fields['field_option']) && $fields['field_option'] == 3 ? $fields['field_35'] : ' ' }}
        </span>
        <span>ตารางเมตร</span>
        <br>

        <span>({{ isset($fields['field_option']) && $fields['field_option'] == 4 ? '/' : ' ' }})</span>
        <span>หนังสือรับรองการแจ้งตั้งสถานที่สะสมอาหาร (สอ.7) โดยมีพื้นที่ประกอบการ</span>
        <span class="dotted-line"
            style="min-width: 15%;">{{ isset($fields['field_option']) && $fields['field_option'] == 4 ? $fields['field_35'] : ' ' }}</span>
        <span>ตารางเมตร</span>
    </div>
