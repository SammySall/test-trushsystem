...
<body class="d-flex bg-body-secondary">
    ...
    <div class="d-flex flex-column flex-shrink-0 bg-white p-3" style="width: 250px; height: 100vh;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="#" class="nav-link active">ข้อมูลฟอร์มที่ส่งเข้ามา</a>
            </li>
            <li>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="data_table_length">
                            <label class="d-flex align-items-center">
                                ...
                                <select name="data_table_length" aria-controls="data_table"
                                    class="form-select form-select-sm me-1" style="width: auto;">
                        ...
                        <div id="data_table_filter">
                            <label class="d-flex align-items-center justify-content-end">
                                ...
                                <input type="search" class="form-control form-control-sm" placeholder=""
                                    aria-controls="data_table" style="width: auto;">
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <table class="table table-bordered table-striped dataTable no-footer" id="data_table"
                            ...
                            <thead class="text-center">
                                <tr>
                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="data_table"
                                        rowspan="1" colspan="1" aria-sort="ascending"
                                        aria-label="วันที่ส่ง: activate to sort column descending"
                                        style="width: 165.547px;">วันที่ส่ง</th>
                                    <th class="sorting" tabindex="0" aria-controls="data_table" rowspan="1"
                                        colspan="1" aria-label="ชื่อผู้ส่งฟอร์ม: activate to sort column ascending"
                                        style="width: 172.375px;">ชื่อผู้ส่งฟอร์ม</th>
                                    <th class="sorting" tabindex="0" aria-controls="data_table" rowspan="1"
                                        colspan="1" aria-label="ผู้กดรับฟอร์ม: activate to sort column ascending"
                                        style="width: 172.562px;">ผู้กดรับฟอร์ม</th>
                                    <th class="sorting" tabindex="0" aria-controls="data_table" rowspan="1"
                                        colspan="1" aria-label="สถานะ: activate to sort column ascending"
                                        style="width: 105.109px;">สถานะ</th>
                                    <th class="sorting" tabindex="0" aria-controls="data_table" rowspan="1"
                                        colspan="1" aria-label="จัดการ: activate to sort column ascending"
                                        style="width: 154.406px;">จัดการ</th>
                                </tr>
                            </thead>
                            {{-- ข้อมูลในตาราง --}}
